...
theory and cryptography. Expected thesis work at RU is on computer proofs and
counting of permutation pattern avoidance classes in the field of Combinatorics.
Am taking courses on distributed systems and machine learning.}
...
\cvitem{DevOps}{Linux, Docker, LXD, Jenkins, Travis, Bash, Vagrant, git}
\cvitem{Other}{SQL, Octave/MatLab, NumPy, R, \LaTeX}
...
\section{Teaching}
\cventry{Fall 2018}{Assistant Teacher}{Reykjavik University}{Reykjavik}{}
