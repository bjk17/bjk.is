...
\address{Uilenstede 168}{1183AP Amstelveen}{Netherlands}
...
\section{Education}
\cventry{2017 -- \emph{curr.}}{M.Sc.\@ in Computer Science}{Vrije Universiteit 
Amsterdam}{Netherlands}{} {Joint program with University of Amsterdam, Parallel
...
\cvitem{DevOps}{Linux, Docker, LXD, Jenkins, Travis, Bash}
\cvitem{Other}{SQL, Octave/MatLab, R, \LaTeX}

\section{Work experience}
\cventry{2015 -- 2017}{Software Developer}{WuXi NextCODE}{Reykjavik}{Iceland}
...
%~ \cventry{May -- July 2015}{Software Developer}{Handpoint}{Kopavogur}{Iceland}
%~ {Implementing protocols with partners and developing card reader software. 
%~ Quit because the job turned out to be different and not as demanding as 
%~ promised in the interviewing process.}
...
\cvitem{url}{\url{https://arxiv.org/abs/1607.03018} \emph{(with additions from Henning)}}

\section{Teaching}
\cventry{Fall 2013}{Assistant Teacher}{University of Iceland}{Reykjavik}{}
...
\cvitem{math}{I am deeply intrigued by the concept of infinity
    ...
    junior college I participated in many mathematics competitions 
...
%~ \cvitemwithcomment{Swedish}{fluent}{I lived in Sweden for ten years}
